            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Product List</h3>
                  <form class="form-inline ml-3" style="position: absolute;right: 350px;top: 12px;height: 15px">
                  ...
                  <div class="form-group" style="position: absolute;right:110px;bottom: -6px ">
                      <select class="form-control" v-model="form.category">
                          <option disabled value = "">Select Category</option>
                          <option
                              v-for=" cat  in categories" :key="cat"
                              :value="cat"
                              :selected="cat === form.category">
                              {{ cat }}</option>
                      </select>
                  </div>
